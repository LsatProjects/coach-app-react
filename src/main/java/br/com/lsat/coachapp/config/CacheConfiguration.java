package br.com.lsat.coachapp.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(br.com.lsat.coachapp.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(br.com.lsat.coachapp.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
