    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="coachappApp.training.home.createOrEditLabel">
              <Translate contentKey="coachappApp.training.home.createOrEditLabel">Create or edit a Training</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
            ...
            {loading ? (
              ...
              <AvForm model={isNew ? {} : trainingEntity} onSubmit={this.saveEntity}>
                ...
                <AvGroup>
                  ...
                  <AvField id="training-description" type="text" name="description" />
                </AvGroup>
