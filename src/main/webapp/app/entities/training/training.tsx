...
import { getSearchEntities, getEntities } from './training.reducer';
...
export interface ITrainingState extends IPaginationBaseState {
  search: string;
}
...
export class Training extends React.Component<ITrainingProps, ITrainingState> {
  ...
  render() {
    const { trainingList, match, totalItems } = this.props;
    return (
      <div>
        <h2 id="training-heading">
          <Translate contentKey="coachappApp.training.home.title">Trainings</Translate>
          <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="coachappApp.training.home.createLabel">Create new Training</Translate>
          </Link>
        </h2>
        <Row>
          <Col sm="12">
              ...
              <AvGroup>
                <InputGroup>
                  <AvInput
                    ...
                    placeholder={translate('coachappApp.training.home.search')}
                  />
            ...
            <thead>
              <tr>
                ...
                <th className="hand" onClick={this.sort('name')}>
                  <Translate contentKey="coachappApp.training.name">Name</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th className="hand" onClick={this.sort('description')}>
                  <Translate contentKey="coachappApp.training.description">Description</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
