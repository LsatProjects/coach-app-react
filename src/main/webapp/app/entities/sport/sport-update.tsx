...
export interface ISportUpdateState {
  isNew: boolean;
}

export class SportUpdate extends React.Component<ISportUpdateProps, ISportUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
  ...
  handleClose = () => {
    this.props.history.push('/entity/sport');
  };

  render() {
    const { sportEntity, loading, updating } = this.props;
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="coachappApp.sport.home.createOrEditLabel">
              <Translate contentKey="coachappApp.sport.home.createOrEditLabel">Create or edit a Sport</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
          <Col md="8">
            {loading ? (
              ...
              <AvForm model={isNew ? {} : sportEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    <Label for="id">
                ...
                <AvGroup>
                  ...
                  <AvField id="sport-description" type="text" name="description" />
                </AvGroup>
                <Button tag={Link} id="cancel-save" to="/entity/sport" replace color="info">
